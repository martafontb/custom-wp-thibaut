 ...
 * 
 */
 gulp.task('default', gulp.series('clean', 'styles', 'images', 'scripts', 'fonts' , 'watch'))

 gulp.task('build', gulp.series('clean', 'styles', 'images', 'scripts', 'fonts',  'zip'))
